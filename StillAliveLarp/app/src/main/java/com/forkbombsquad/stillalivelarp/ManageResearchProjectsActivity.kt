...
class ManageResearchProjectsActivity : NoStatusBarActivity() {
    ...
    private fun reload() {
        DataManager.shared.load(lifecycleScope, stepFinished = {
            ...
            researchProjects = DataManager.shared.researchProjects
            buildView()
        })
        buildView()
    }
    ...
    private fun setupView() {
        researchProjects = DataManager.shared.getPassedData(AdminPanelActivity::class, DataManagerPassedDataKey.RESEARCH_PROJECT_LIST)!!

        loadingLayout = findViewById(R.id.mrp_loadinglayout)
    ...
    private fun buildView() {
        DataManager.shared.handleLoadingTextAndHidingViews(loadingLayout, listOf(outerLayout)) {
