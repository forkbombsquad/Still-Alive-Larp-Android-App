...
class SelectCharacterToRegisterPrimaryWeaponActivity : NoStatusBarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_select_character_to_register_primary_weapon)
        setupView()
    }

    private fun setupView() {
        progressbar = findViewById(R.id.selectcharforprimweapon_progressbar)
        layout = findViewById(R.id.selectcharforprimweapon_layout)
            ...
            DataManager.shared.allCharacters.ifLet { chars ->
                chars.alphabetized().forEachIndexed { index, char ->
                    ...
                    arrow.setOnClick {
                        ...
                        val intent = Intent(this, RegisterPrimaryWeaponActivity::class.java)
