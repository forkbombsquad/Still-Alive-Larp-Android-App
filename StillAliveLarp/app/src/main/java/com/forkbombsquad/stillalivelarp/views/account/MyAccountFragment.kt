...
import com.forkbombsquad.stillalivelarp.views.shared.ViewAwardsActivity
...
import com.forkbombsquad.stillalivelarp.views.shared.ViewCharacterStatsActivity
import com.forkbombsquad.stillalivelarp.views.shared.ViewGearActivity
import com.forkbombsquad.stillalivelarp.views.shared.ViewPlayerStatsActivity
    ...
    private fun setupView(v: View) {
        ...
        characterPanel.setOnClicks(
            ...
            viewSkillsListCallback = {
                ...
                DataManager.shared.setPassedData(this::class, DataManagerPassedDataKey.SELECTED_CHARACTER, DataManager.shared.getActiveCharacter()!!)
                val intent = Intent(v.context, SkillsListActivity::class.java)
                startActivity(intent)
            },
            viewBioCallback = {
                DataManager.shared.setUpdateCallback(this::class) {
            ...
            viewXpReductionsCallback = {
                DataManager.shared.setPassedData(this::class, DataManagerPassedDataKey.SELECTED_CHARACTER, DataManager.shared.getActiveCharacter()!!)
                val intent = Intent(v.context, XpReductionsListActivity::class.java)
                startActivity(intent)
            },
            viewAwardsCallback = {
