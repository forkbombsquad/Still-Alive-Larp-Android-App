...
class SelectCharacterToAwardActivity : NoStatusBarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_select_character_to_award)
        setupView()
    }

    private fun setupView() {
        progressbar = findViewById(R.id.selectchartoaward_progressbar)
        layout = findViewById(R.id.selectchartoaward_layout)
            ...
            DataManager.shared.allCharacters.ifLet { chars ->
                chars.alphabetized().forEachIndexed { index, char ->
                    ...
                    arrow.setOnClick {
                        ...
                        val intent = Intent(this, AwardCharacterActivity::class.java)
